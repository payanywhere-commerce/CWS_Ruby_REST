...
require_relative 'Services/ApplicationAndMerchantSetup/ApplicationDataManagement'
require_relative 'Services/ApplicationAndMerchantSetup/GetServiceInformation'
require_relative 'Services/ApplicationAndMerchantSetup/MerchantProfileManagement'
require_relative 'Services/TransactionProcessing/endpoint_txn'
require_relative 'Services/TransactionProcessing/TerminalCaptureWorkflow'
require_relative 'Services/TransactionProcessing/HostCaptureWorkflow'
require_relative 'Services/TransactionManagement/endpoint_txn_mgmt_services'
require_relative 'Services/TransactionManagement/TMSWorkflow'
	...
	class Client
      ...
      request.basic_auth(@session_token,nil)
        ...
        p body if @do_log
			...
			Nab::SimpleResponse.new(response)
		end
		...
		def sign_on(identity_token)
			...
			# Pro-tip: The SAML assertion can be read and verified of its duration.
...
NabCWSClient = Nab::Client
NabCWS_endpoint_svcinfo = Nab::ServiceInformation
NabCWS_endpoint_merchinfo = Nab::MerchantManagement
NabCWS_endpoint_appdata = Nab::ApplicationManagement
NabCWS_endpoint_txn = Nab::Txn
NabCWS_endpoint_tms = Nab::Tms
