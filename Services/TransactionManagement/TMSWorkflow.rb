# Copyright (c) 2014 North American Bancard - All Rights Reserved.
#
...
module Workflows
  def self.TMS(client)
    ...
    txn_summaries_response = NabCWS_endpoint_tms.query_transactions_summary(client, {})
    ...
    txn_details_response = NabCWS_endpoint_tms.query_transactions_detail(client, query_txn_details)
    ...
    family_details_response = NabCWS_endpoint_tms.query_transactions_families(client, query_family_details)
    ...
    query_batch_response = NabCWS_endpoint_tms.query_batch(client, query_family_details)
